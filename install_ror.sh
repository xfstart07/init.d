...
# instead rvm install url to taobao
echo "......instead db......"
...
echo "......Install Openssl and Readline......"
rvm pkg install openssl --with-openssl-dir=/usr/local
...
# Install Latest version of Rails and Bundler
echo "..........Installing Rails gem................"
gem install bundler rails >>$LOG_FILE
echo ".........Done"
